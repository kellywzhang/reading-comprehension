...
attended = tf.constant([[[0,1,2],[0,1,1],[0,1,2],[0,1,2]],[[0,1,2],[0,1,0],[0,1,2],[0,1,2]]], dtype=tf.float32) #2,4,3
...
num = tf.exp(dot_prod) #batch x time
...
#print(attending_tensor.get_shape())
